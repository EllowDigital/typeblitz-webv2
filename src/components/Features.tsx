...
const featureData = [
  {
    ...
    description: "Our smart algorithm adapts to your skill level, providing progressive challenges that steadily enhance your typing speed and accuracy."
  },
  {
    icon: <Layout className="w-8 h-8 text-neon" />,
    title: "User-Friendly Interface",
    description: "Clean, distraction-free design helps you focus on what matters most—improving your typing skills without complexity."
  },
  {
    icon: <Package className="w-8 h-8 text-neon" />,
    title: "Compact Size",
    description: "TypeBlitz is lightweight, using minimal system resources while delivering maximum performance on any desktop computer."
  },
  {
    icon: <LineChart className="w-8 h-8 text-neon" />,
    title: "Progress Tracking with Visual Charts",
    description: "Monitor your improvement with detailed analytics and visual representations of your typing speed, accuracy, and consistency."
  }
];
      ...
      <div className="container px-4 md:px-6">
        <div className="text-center mb-16">
          ...
          <p className="section-subtitle">
            TypeBlitz combines advanced technology with simplicity to deliver the ultimate typing improvement experience.
          </p>
        </div>
