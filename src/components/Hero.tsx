  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-1/4 right-1/3 w-96 h-96 bg-neon/10 rounded-full filter blur-[120px] animate-float" style={{ animationDelay: '-1.5s' }} />
        <div className="absolute top-2/3 left-1/2 w-72 h-72 bg-neon/15 rounded-full filter blur-[80px] animate-float" style={{ animationDelay: '-3s' }} />
      </div>
            ...
            <div className="rounded-lg bg-dark overflow-hidden">
              ...
              <div className="p-6 text-left">
                <div className="typing-container">
                  <p className="typing-text typing-cursor">Your journey to faster typing starts here...</p>
                </div>
              </div>
            </div>
          </div>
