      ...
      <main className="container px-4 md:px-6 py-12 max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-muted-foreground">
          <section>
            ...
            <p>
              Welcome to TypeBlitz. We respect your privacy and are committed to protecting your personal data. 
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>Usage statistics: We anonymously collect information about how you use TypeBlitz, including typing speed, accuracy, and frequency.</li>
              <li>Device information: Basic information about your operating system and device specifications.</li>
              <li>Settings and preferences: Your application settings and customization preferences.</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3 text-foreground">6. Updates to This Policy</h2>
            <p>
          ...
          <section>
            ...
            <p>
              If you have any questions about this Privacy Policy, please contact us at privacy@typeblitz.com.
            </p>
          </section>
