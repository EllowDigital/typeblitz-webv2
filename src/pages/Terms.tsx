      ...
      <main className="container px-4 md:px-6 py-12 max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-muted-foreground">
          <section>
            ...
            <p>
              By accessing and using TypeBlitz, you agree to be bound by these Terms of Use and all applicable laws and regulations. 
              If you do not agree with any of these terms, you are prohibited from using the application.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              TypeBlitz grants you a personal, non-transferable, non-exclusive license to use the application for personal, 
              non-commercial purposes. This license does not include:
            </p>
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>Modifying or copying application materials</li>
              <li>Using the materials for any commercial purpose</li>
              <li>Attempting to decompile or reverse engineer any software contained in TypeBlitz</li>
          ...
          <section>
            ...
            <p>
              The materials on TypeBlitz are provided "as is". We make no warranties, expressed or implied, and hereby 
          ...
          <section>
            ...
            <p>
              In no event shall TypeBlitz or its suppliers be liable for any damages (including, without limitation, 
              damages for loss of data or profit, or due to business interruption) arising out of the use or inability 
              to use TypeBlitz, even if we or an authorized representative has been notified orally or in writing of 
          ...
          <section>
            ...
            <p>
              The materials appearing in TypeBlitz could include technical, typographical, or photographic errors. 
              We do not warrant that any of the materials are accurate, complete, or current. We may make changes 
              to the materials at any time without notice.
            </p>
          </section>
          
          <section>
            <h2 className="text-xl font-semibold mb-3 text-foreground">6. Modifications to Terms of Use</h2>
            <p>
              We may revise these terms of use at any time without notice. By using TypeBlitz you are agreeing to 
